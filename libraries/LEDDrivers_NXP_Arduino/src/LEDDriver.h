...
public:
	...
	enum reg_num {
		/*00*/ MODE1, MODE2,
		/*02*/ LEDOUT0, LEDOUT1, LEDOUT2, LEDOUT3, LEDOUT4, LEDOUT5,
		/*08*/ GRPPWM, GRPFREQ,
		/*0A*/ PWM0,  PWM1,  PWM2,  PWM3,  PWM4,  PWM5,
		/*10*/ PWM6,  PWM7,  PWM8,  PWM9,  PWM10, PWM11,
		/*16*/ PWM12, PWM13, PWM14, PWM15, PWM16, PWM17,
		/*1C*/ PWM18, PWM19, PWM20, PWM21, PWM22, PWM23,
		/*22*/IREF0,  IREF1,  IREF2,  IREF3,  IREF4,  IREF5,
		/*28*/ IREF6,  IREF7,  IREF8,  IREF9,  IREF10, IREF11,
		/*2E*/ IREF12, IREF13, IREF14, IREF15, IREF16, IREF17,
		/*34*/ IREF18, IREF19, IREF20, IREF21, IREF22, IREF23,
		/*3A*/ OFFSET,
		/*3B*/ SUBADR1, SUBADR2, SUBADR3, ALLCALLADR,
		/*3F*/ PWMALL, IREFALL,
		/*41*/ EFLAG0, EFLAG1, EFLAG2, EFLAG3, EFLAG4, EFLAG5
	};
