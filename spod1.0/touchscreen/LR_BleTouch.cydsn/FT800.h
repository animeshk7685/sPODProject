...
#define FT_DISPLAY_VSYNC0_QVGA 			(0L)
#define FT_DISPLAY_VSYNC1_QVGA 			(2L)
#define FT_DISPLAY_VOFFSET_QVGA 		(2L)//(13L)
#define FT_DISPLAY_HSYNC0_QVGA 			(0L)
#define FT_DISPLAY_HSYNC1_QVGA 			(1L)//(10L)
#define FT_DISPLAY_HOFFSET_QVGA 		(10L)//(70L)

#define FT_DISPLAY_VCYCLE_QVGA 			(328L)//(408L)
#define FT_DISPLAY_HCYCLE_QVGA 			(280L)//(263L)

#define FT_DISPLAY_VSIZE_QVGA 			(320L)//display width
#define FT_DISPLAY_HSIZE_QVGA 			(240L)//display height

#define FT_DISPLAY_PCLKPOL_QVGA 		(1L)//(0L)
#define FT_DISPLAY_SWIZZLE_QVGA 		(2L)
#define FT_DISPLAY_PCLK_QVGA 			(8L)

#define RETRO_DISPLAY_VSYNC0_QVGA 		(4L)
#define RETRO_DISPLAY_VSYNC1_QVGA 		(6L)
#define RETRO_DISPLAY_VOFFSET_QVGA 		(8L)
#define RETRO_DISPLAY_VCYCLE_QVGA 		(328L)
#define RETRO_DISPLAY_HSYNC0_QVGA 		(10L)
#define RETRO_DISPLAY_HSYNC1_QVGA 		(20L)
#define RETRO_DISPLAY_HOFFSET_QVGA 		(40L)
#define RETRO_DISPLAY_HCYCLE_QVGA 		(280L)
#define RETRO_DISPLAY_HSIZE_QVGA 		(240L)
#define RETRO_DISPLAY_VSIZE_QVGA 		(320L)
#define RETRO_DISPLAY_PCLKPOL_QVGA 		(1L)
#define RETRO_DISPLAY_SWIZZLE_QVGA 		(2L)
#define FT_DISPLAY_PCLK_QVGA 			(8L)
*/
