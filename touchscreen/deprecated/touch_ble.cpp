...
//uint8_t bleRxBuffer[32];
//uint8_t bleTxBuffer[20];
uint8_t bleRxBuffer[100];
uint8_t bleTxBuffer[100];
...
//uint8_t lastTemp[4] = {0};
//uint8_t lastBatt[4] = {0};
//
...
void ProcessPacket(uint8_t packetLength)//, void* params)
{
...
void writePassKey(uint32_t thisKey)
{
    ...
    handleValuePair.value.val = (uint8_t *)&thisKey;
